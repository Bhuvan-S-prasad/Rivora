...
const EchoCard = ({
    ...
    const onTouchEnd = () => {
        ...
        if (isLeftSwipe && images && previewIndex !== null && previewIndex < images.length - 1) {
            // Swipe Left -> Next Image
            setPreviewIndex(previewIndex + 1);
        }
        if (isRightSwipe && images && previewIndex !== null && previewIndex > 0) {
                            ...
                            >
                                {images.map((url, index) => (
                                    <div
                                        ...
                                        className={`relative rounded-xl overflow-hidden border border-light-4/20 cursor-pointer hover:opacity-90 transition-opacity ${images.length === 1
                                            ? "w-full max-h-[500px]"
                    ...
                    <div className="relative max-w-full max-h-full w-full h-full flex items-center justify-center">
                        ...
                        {previewIndex > 0 && (
                            <button
                                ...
                                className="absolute left-4 z-50 p-3 rounded-full bg-black/50 hover:bg-black/70 text-white transition-colors hidden sm:block"
                            >
                        ...
                        {previewIndex < images.length - 1 && (
                            <button
                                ...
                                className="absolute right-4 z-50 p-3 rounded-full bg-black/50 hover:bg-black/70 text-white transition-colors hidden sm:block"
                            >
